...
create table FacturaDetalle(
    ...
    productoId varchar(7),
    cantidad double  not null, 
    totalParcial decimal(10,2),
    cotizacionIdFacturaDetalle int(10) UNSIGNED ZEROFILL,
	CONSTRAINT FK_productoFacDetalle FOREIGN KEY (productoId) REFERENCES InventarioProductos(productoId),
	CONSTRAINT FK_CotizacionFacturaDetalle FOREIGN KEY (cotizacionIdFacturaDetalle) REFERENCES Cotizacion(cotizacionId)
...
create table FacturaDetalleBackUp(
    ...
    productoIdBackup varchar(7),
    cantidadBackup double  not null, 
    totalParcialBackup decimal(10,2) not null,
    cotizacionIdFactura int(10) UNSIGNED ZEROFILL,
	CONSTRAINT FK_productoFacDetalleBackup FOREIGN KEY (productoIdBackup) REFERENCES InventarioProductos(productoId),
    CONSTRAINT FK_CotizacionFacturaDetalleBackUp FOREIGN KEY (cotizacionIdFactura) REFERENCES Cotizacion(cotizacionId)
);
